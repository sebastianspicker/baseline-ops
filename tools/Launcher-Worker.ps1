...
[CmdletBinding()]
param(
  [string]$ManifestPath = $env:WIN_MDM_LAUNCHER_MANIFEST,
  [string]$ManifestBase64 = $env:WIN_MDM_LAUNCHER_MANIFEST_B64
)
...
try {
  ...
  $startGateName = [string]$env:WIN_MDM_LAUNCHER_START_GATE
