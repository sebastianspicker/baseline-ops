...
$v2Result = Get-V2ResultObject -ScriptName '45-WEF-Client-Forwarding-Readiness-Audit.ps1' -Mode $Mode -Result $resultToken -Findings @($script:Findings.ToArray()) -Summary $result.Summary -Metadata @{ Indicators = $result.Indicators }
