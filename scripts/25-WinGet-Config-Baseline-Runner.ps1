...
$v2Result = Get-V2ResultObject -ScriptName '25-WinGet-Config-Baseline-Runner.ps1' -Mode $Mode -Result $resultToken -Findings @($script:Findings.ToArray()) -Summary $summary -Metadata @{}
