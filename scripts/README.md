...
| `21-EmergencyKillSwitch.ps1` | Emergency containment | Remediate |
...
| `25-WinGet-Config-Baseline-Runner.ps1` | WinGet configuration baseline | Audit |
...
| `32-Firewall-Logging-Audit.ps1` | Firewall logging | Audit |
...
| `38-SecurityOptions-Drift.ps1` | Security options drift | Audit |
